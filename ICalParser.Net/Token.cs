...
namespace Semaview.Shared.ICalParser
{
    ...
    public enum TokenValue
    {
        ...
        Tvevent, Tvvenue, Tvtodo, Tvjournal, Tvfreebusy, Tvtimezone,  // these are a subproperty of BEGINEND which are COMPONENTs
        ...
        public Token(string _tokenText, ScannerState _state, bool quoteFlag)
        {
            ...
            switch (state)
            {
                ...
                case ScannerState.ParseParms:
                    tokenText = _tokenText; // HttpUtility.HtmlEncode(_tokenText);
                    if (quoteFlag)
                    {
