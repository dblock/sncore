///
/// modified from http://www.codeproject.com/dotnet/NGif.asp 
/// http://blogs.geekdojo.net/brian/articles/Cropper.aspx 
/// http://weblogs.asp.net/jgalloway/archive/2006/11/07/Animated-GIF-Plugin-for-Cropper-_2B00_-some-.NET-Animated-GIF-code.aspx
/// 
...
namespace Gif.Components
{
    public class AnimatedGifEncoder
    {
         ...
         */
        public void Start(Stream os)
        {
            if (os == null) throw new ArgumentNullException();
            closeStream = false;
            fs = os;
        ...
        protected void GetImagePixels()
        {
             ...
             )
            {
                ...
                image = GetResizedImage(image, new Size(width, height));
            }
            /*
             ToDo:
