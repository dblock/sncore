<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="PlacePicturesManage.aspx.cs" Inherits="PlacePicturesManage" Title="Pictures" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <div class="sncore_navigate">
  ...
  <asp:HyperLink CssClass="sncore_navigate_item" ID="linkPlaceName" Text="Place"
   runat="server" />
  <asp:Label CssClass="sncore_navigate_item" ID="linkPlacePictures" Text="Pictures" runat="server" />
 </div>
    ...
    <SnCoreWebControls:PagedGrid CellPadding="4" runat="server" ID="gridManage" PageSize="15"
     ...
     <Columns>
      ...
      <asp:TemplateColumn ItemStyle-HorizontalAlign="Center">
       <itemtemplate>
     <a href='PlacePictureView.aspx?id=<%# Eval("Id") %>'><img 
      border="0" src='PlacePictureThumbnail.aspx?id=<%# Eval("Id") %>&CacheDuration=0' /></a>
    </itemtemplate>
      </asp:TemplateColumn>
      ...
      <asp:TemplateColumn>
       <itemtemplate>
        <a href='PlacePictureEdit.aspx?pid=<%# base.RequestId %>&id=<%# base.Render(Eval("Id")) %>'>Edit</a>
       </itemtemplate>
      </asp:TemplateColumn>
