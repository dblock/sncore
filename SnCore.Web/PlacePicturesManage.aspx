 ...
 <asp:UpdatePanel ID="panelGrid" runat="server" UpdateMode="Always">
  <ContentTemplate>
   <SnCoreWebControls:PagedList CssClass="sncore_account_table" runat="server" RepeatDirection="Horizontal"
    ...
    <ItemTemplate>
     <a href='PlacePictureEdit.aspx?id=<%# Eval("Id") %>&pid=<%# Eval("PlaceId") %>'>
      <img border="0" src="PlacePictureThumbnail.aspx?id=<%# Eval("Id") %>&CacheDuration=0" alt="<%# base.Render(Eval("Name")) %>" />
     </a>
