...
public partial class AccountPicturesManage : AuthenticatedPage
{
    ...
    public void GetData(object sender, EventArgs e)
    {
        ...
        gridManage.VirtualItemCount = AccountService.GetAccountPicturesCount(SessionManager.Ticket);
    ...
    void gridManage_OnGetDataSource(object sender, EventArgs e)
    {
        ...
        gridManage.DataSource = AccountService.GetAccountPictures(SessionManager.Ticket, options);
    }
