<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="AccountOpenIdsManage.aspx.cs" Inherits="AccountOpenIdsManage" Title="Account | OpenIds" %>
   ...
   <tr>
    ...
    <td valign="top" width="*">
     ...
     <div style="margin-left: 20px;" class="sncore_link">
      <a target="_blank" href="http://openid.net/">&#187; what's this?</a>
      <a target="_blank" href="http://videntity.org/">&#187; get one</a>
     </div>
