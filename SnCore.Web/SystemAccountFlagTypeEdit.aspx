<%@ Page Language="C#" MasterPageFile="~/SnCoreAccount.master" AutoEventWireup="true"
 CodeFile="SystemAccountFlagTypeEdit.aspx.cs" Inherits="SystemAccountFlagTypeEdit" Title="Account Flag Type" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="AccountContentPlaceHolder" runat="Server">
 ...
 <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="SystemAccountFlagTypesManage.aspx"
  runat="server" />
