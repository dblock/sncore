<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AccountGroupPicturesViewControl.ascx.cs"
 Inherits="AccountGroupPicturesViewControl" %>
  ...
  <SnCoreWebControls:PagedList runat="server" ID="picturesView" RepeatColumns="1" RepeatRows="5"
   ...
   <ItemTemplate>
    <a href='<%# string.Format("AccountGroupPictureView.aspx?id={0}", Eval("Id")) %>'>
     <img border="0" src='<%# string.Format("AccountGroupPictureThumbnail.aspx?id={0}", Eval("Id")) %>'
