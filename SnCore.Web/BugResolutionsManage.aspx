<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true" CodeFile="BugResolutionsManage.aspx.cs"
   ...
   <td valign="top">
    ...
    <SnCoreWebControls:PagedGrid CellPadding="4" runat="server" ID="gridManage" PageSize="15"
     ...
     <Columns>
      ...
      <asp:TemplateColumn>
       <itemtemplate>
        <a href='BugResolutionEdit.aspx?id=<%# base.Render(Eval("Id")) %>'>
         Edit</a>
       </itemtemplate>
      </asp:TemplateColumn>
