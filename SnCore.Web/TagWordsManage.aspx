<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="TagWordsManage.aspx.cs" Inherits="TagWordsManage" Title="Tags | Words" %>
    ...
    <table class="sncore_account_table">
     ...
     <tr>
      <td colspan="2" align="center">
       <asp:Button ID="buttonPromote" runat="server" OnClick="buttonPromote_Click" CssClass="sncore_form_button" Text="Pro/Demote" />
       <asp:Button ID="buttonExclude" runat="server" OnClick="buttonExclude_Click" CssClass="sncore_form_button" Text="Inc/Exclude" />
      </td>
     </tr>
    </table>
    <SnCoreWebControls:PagedGrid CellPadding="4" runat="server" ID="gridManage" PageSize="25" AllowPaging="true"
