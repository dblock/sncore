 ...
 <tr>
  <td colspan="2">
   <asp:LinkButton CausesValidation="false" ID="lookupPlace" runat="server" Text="&#187; lookup an existing location"
    CssClass="sncore_link" OnClick="lookupPlace_Click" Enabled="false" />
   <asp:LinkButton CausesValidation="false" ID="addPlace" runat="server" Text="&#187; add a new location"
    CssClass="sncore_link" OnClick="addPlace_Click" />
  </td>
 </tr>
</table>
...
<asp:Panel ID="panelLookup" runat="server">
 <table class="sncore_account_table">
  <tr>
  ...
  <tr>
   ...
   <td class="sncore_form_value">
    <div style="color: red; font-weight: bold; font-size: smaller;">
