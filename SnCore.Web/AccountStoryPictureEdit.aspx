<%@ Page Language="C#" MasterPageFile="~/SnCoreAccount.master" AutoEventWireup="true"
 CodeFile="AccountStoryPictureEdit.aspx.cs" Inherits="AccountStoryPictureEdit" Title="AccountStory | Picture" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="AccountContentPlaceHolder" runat="Server">
 ...
 <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="AccountStoryPicturesManage.aspx"
  runat="server" />
