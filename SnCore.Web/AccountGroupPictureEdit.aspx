<%@ Page Language="C#" MasterPageFile="~/SnCoreAccount.master" AutoEventWireup="true"
 CodeFile="AccountGroupPictureEdit.aspx.cs" Inherits="AccountGroupPictureEdit" Title="AccountGroup | Picture" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="AccountContentPlaceHolder" runat="Server">
 ...
 <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="AccountGroupPicturesManage.aspx"
  runat="server" />
