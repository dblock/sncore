...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
 <div class="sncore_h2">
  Featured <% Response.Write(Renderer.Render(this.Feature.DataObjectName)); %>
 </div>
 <table class="sncore_table">
  <tr>
   <td>
    ...
    <p>
     Your <a href='<% Response.Write(Renderer.Render(this.Feature.DataObjectName)); %>View.aspx?id=<% Response.Write(Renderer.Render(this.Feature.DataRowId)); %>'>
