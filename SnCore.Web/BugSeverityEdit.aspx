<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="BugSeverityEdit.aspx.cs" Inherits="BugSeverityEdit" Title="Bug Severity" %>
 ...
 <table class="sncore_inner_table">
  <tr>
   ...
   <td valign="top">
    ...
    <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="BugSeveritiesManage.aspx"
     runat="server" />
