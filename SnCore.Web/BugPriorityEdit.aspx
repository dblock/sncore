<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="BugPriorityEdit.aspx.cs" Inherits="BugPriorityEdit" Title="Bug Priority" %>
 ...
 <table class="sncore_inner_table">
  <tr>
   ...
   <td valign="top">
    ...
    <asp:HyperLink ID="linkBack" Text="Cancel" CssClass="sncore_cancel" NavigateUrl="BugPrioritiesManage.aspx"
     runat="server" />
