  ...
  <tr>
   <td>
    ...
    <p>
     ...
     <a href="DiscussionPost.aspx?did=<% Response.Write(this.DiscussionPost.DiscussionId); %>&pid=<% Response.Write(this.DiscussionPost.Id); %>&ReturnUrl=<% Response.Write(this.ReturnUrl); %>#edit">&#187; Reply</a>
     <a href="DiscussionPost.aspx?did=<% Response.Write(this.DiscussionPost.DiscussionId); %>&pid=<% Response.Write(this.DiscussionPost.Id); %>&ReturnUrl=<% Response.Write(this.ReturnUrl); %>&Quote=true#edit">&#187; Quote</a>
    </p>
   </td>
  </tr>
 </table>
