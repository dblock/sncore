<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="BugStatusEdit.aspx.cs" Inherits="BugStatusEdit" Title="Bug Status" %>
 ...
 <table class="sncore_inner_table">
  <tr>
   ...
   <td valign="top">
    ...
    <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="BugStatusesManage.aspx"
     runat="server" />
