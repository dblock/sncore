...
public partial class EmailAccountGroupAccountRequestReject : AuthenticatedPage
{
    ...
    {
        Title = string.Format("Your membership request to {0} was rejected", Renderer.Render(AccountGroupAccountRequest.AccountGroupName));
