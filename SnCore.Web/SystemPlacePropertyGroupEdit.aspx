<%@ Page Language="C#" MasterPageFile="~/SnCoreAccount.master" AutoEventWireup="true" CodeFile="SystemPlacePropertyGroupEdit.aspx.cs"
 Inherits="SystemPlacePropertyGroupEdit" Title="Place Property Group" %>

<%@ Register TagPrefix="SnCoreWebControls" Namespace="SnCore.WebControls" Assembly="SnCore.WebControls" %>
<asp:Content ID="Content" ContentPlaceHolderID="AccountContentPlaceHolder" runat="Server">
 <div class="sncore_navigate">
  <asp:Label CssClass="sncore_navigate_item" ID="linkPlace" Text="Place" runat="server" />
  <asp:Label CssClass="sncore_navigate_item" ID="linkItem" Text="Property Group" runat="server" />
 </div>
 <div class="sncore_h2">
  Property Group
 </div>
 <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="SystemPlacePropertyGroupsManage.aspx"
  runat="server" />
 ...
 <asp:Panel ID="panelProperties" runat="server">
  ...
  <asp:HyperLink ID="linkNewProperty" Text="&#187; Create New" CssClass="sncore_createnew"
   NavigateUrl="SystemPlacePropertyEdit.aspx" runat="server" />
