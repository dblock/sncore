<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="BugResolutionEdit.aspx.cs" Inherits="BugResolutionEdit" Title="Bug Resolution" %>
 ...
 <table class="sncore_inner_table">
  <tr>
   ...
   <td valign="top">
    ...
    <asp:HyperLink ID="linkBack" Text="&#187; Cancel" CssClass="sncore_cancel" NavigateUrl="BugResolutionsManage.aspx"
     runat="server" />
