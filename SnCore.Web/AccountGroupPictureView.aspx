<%@ Page Language="C#" MasterPageFile="~/SnCore.master" AutoEventWireup="true"
 CodeFile="AccountGroupPictureView.aspx.cs" Inherits="AccountGroupPictureView" Title="AccountGroup | Picture" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
 <asp:UpdatePanel runat="server" ID="panelPicture" UpdateMode="Always">
  <ContentTemplate>
   <div class="sncore_h2">
    <asp:Label ID="labelAccountGroupName" runat="server" Text="AccountGroup" />
   </div>
    ...
    <tr>
      ...
      <SnCoreWebControls:PagedList OnItemCommand="picturesView_ItemCommand" runat="server" ID="picturesView"
       ...
       <ItemTemplate>
        <asp:ImageButton ID="pictureThumbnail" runat="server" CommandName="Picture" CommandArgument='<%# Eval("Id") %>' 
         ImageUrl='<%# string.Format("AccountGroupPictureThumbnail.aspx?id={0}", Eval("Id")) %>' AlternateText='<%# base.Render(Eval("Name")) %>' />
     ...
     <td valign="top" width="*">
      ...
      <div style="text-align: center; width: 100%;">
       <img runat="server" id="inputPicture" src="AccountGroupPictureThumbnail.aspx?id=0" />
      </div>
