...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PlaceWebsite](
	[PlaceWebsite_Id] [int] IDENTITY(1,1) NOT NULL,
	[Account_Id] [int] NOT NULL,
	[Place_Id] [int] NOT NULL,
	[Name] [nvarchar](128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Description] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[Modified] [datetime] NOT NULL,
	[Bitmap] [image] NULL,
 CONSTRAINT [PK_PlaceWebsite] PRIMARY KEY CLUSTERED 
(
	[PlaceWebsite_Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]') AND name = N'IX_PlaceWebsite')
CREATE NONCLUSTERED INDEX [IX_PlaceWebsite] ON [dbo].[PlaceWebsite] 
(
	[Place_Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]') AND name = N'UK_PlaceWebsite')
CREATE UNIQUE NONCLUSTERED INDEX [UK_PlaceWebsite] ON [dbo].[PlaceWebsite] 
(
	[Url] ASC,
	[Place_Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
GO
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]') AND name = N'PK_PlaceWebsite')
ALTER TABLE [dbo].[PlaceWebsite] ADD  CONSTRAINT [PK_PlaceWebsite] PRIMARY KEY CLUSTERED 
(
	[PlaceWebsite_Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PlaceWebsite_Account]') AND parent_object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]'))
ALTER TABLE [dbo].[PlaceWebsite]  WITH CHECK ADD  CONSTRAINT [FK_PlaceWebsite_Account] FOREIGN KEY([Account_Id])
REFERENCES [dbo].[Account] ([Account_Id])
GO
ALTER TABLE [dbo].[PlaceWebsite] CHECK CONSTRAINT [FK_PlaceWebsite_Account]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PlaceWebsite_Place]') AND parent_object_id = OBJECT_ID(N'[dbo].[PlaceWebsite]'))
ALTER TABLE [dbo].[PlaceWebsite]  WITH CHECK ADD  CONSTRAINT [FK_PlaceWebsite_Place] FOREIGN KEY([Place_Id])
REFERENCES [dbo].[Place] ([Place_Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[PlaceWebsite] CHECK CONSTRAINT [FK_PlaceWebsite_Place]
GO
