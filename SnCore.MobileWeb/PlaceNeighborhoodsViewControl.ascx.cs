...
public partial class PlaceNeighborhoodsViewControl : Control
{
    ...
    {
        values.DataSource = SessionManager.GetCollection<PlaceService.TransitDistinctPlaceNeighborhood, PlaceService.ServiceQueryOptions, string, string, string>(
            Country, State, City, null, SessionManager.PlaceService.GetPlaceNeighborhoods);
        values.DataBind();
        base.DataBind();
    }
