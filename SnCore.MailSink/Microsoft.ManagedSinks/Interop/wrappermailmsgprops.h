/*
        ...
        @module wrappermailmsgprops.h | MailMsg Properties for SMTP and NNTP
*/
...
Abstract:
    ...
    Most of this module is the same as the mailmsgprops.h found in the PlatformSDK.
    This module include modifications to allow for range-checking for property IDs.
--*/

#ifndef __WRAPPERMAILPROPS_H__
#define __WRAPPERMAILPROPS_H__

/*=======================================================================*/
// These macros are used to define the tables of property IDs.

#ifdef MIDL_PASS
#define IMMPID_START_LIST(name,start,guid)     typedef enum {\
...
IMMPID_START_LIST(MP,0x1000,"13384CF0-B3C4-11d1-AA92-00AA006BC80B")
    ...
    //  (ie, smtp:user@example.com).  RFC822 address comments are stripped
...
//  Some form of hard failure happened.
//  (This flag is provided to check status of recipient.  It should never be used
//  directly.)
...
#define RP_VOLATILE_FLAGS_MASK      0xF0000000 
                                               ...
                                               //After control of recipients is passed, value
                                               //is undefined.
...
// These are defined for backwards-compatability.  They may be removed
// in the furture.
...
IMMPID_START_LIST(NMP,0x6000,"7433a9aa-20e2-11d2-94d6-00c04fa379f1")
    ...
    //   Flags that describe how the message should be processed.  The 
